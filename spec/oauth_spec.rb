...
describe WeeblyApi::OAuth do
  subject do
    WeeblyApi::OAuth.new do |config|
  ...
  its(:oauth_url) { should == "https://my.weebly.com/api/oauth/authorize?client_id=client_id&scope=scope&response_type=code&redirect_uri=https%3A%2F%2Fexample.com%2Foauth" }
