...
class EntitySubject < WeeblyApi::Entity
  self.url_root = "stuff"

  weebly_reader :id, :parentId, :type, :modify, :override
  weebly_writer :writeOnly
  weebly_accessor :theStatus
...
class EntityUrlSubject < WeeblyApi::Entity
  weebly_reader :id, :parentId

  self.url_root = -> { "parent/#{parent_id}/and" }
end

describe WeeblyApi::Entity do
  let(:data) do
    {
      "id" => 123,
      "parentId" => 456,
  ...
  describe "#[]" do
    ...
    it "gets attributes not revealed by weebly_reader or weebly_accessor" do
